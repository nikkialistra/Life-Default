...
namespace General.Map
{
    ...
    {
        [SerializeField] private int _detailLayer;
        ...
        private void Start()
        {
            ...
            _detailDivider = _terrain.terrainData.heightmapResolution / _terrain.terrainData.detailResolution;
        ...
        public void ClearDetailsAt(Vector3 position, int radius)
        {
            ...
            _terrainData.SetDetailLayer(detailBrushPosition.x, detailBrushPosition.y, _detailLayer, details);
        }
            ...
            out Vector2Int detailBrushSize)
        {
            ...
            detailBrushPosition = brushPosition / _detailDivider;
            detailBrushSize = brushSize / _detailDivider;
        }
