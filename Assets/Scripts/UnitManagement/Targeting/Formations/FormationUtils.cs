...
namespace UnitManagement.Targeting.Formations
{
    public static class FormationUtils
    {
        ...
        public static int ClosestUnitIndexTo(List<UnitFacade> units, Vector3 targetPoint, bool[] assignedUnitsBitmask)
        {
            ...
            for (var i = 0; i < assignedUnitsBitmask.Length; i++)
            {
                ...
                var distanceToPoint = Vector3.Distance(units[i].transform.position, targetPoint);
